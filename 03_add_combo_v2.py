...
def create(menu):
    ...
    while True:
        ...
        if choice == "Edit":
            ...
            menu_temp = {
                new_combo_name: combo_temp
            }
            print(menu_temp)
            menu_temp = edit(menu_temp, new_combo_name)

        elif choice == "Save":
            print(menu)
            menu = add(menu, menu_temp)
            print(menu)
            return menu
        elif choice == "Cancel":
            choice = ynbox(f"Are you sure? All of *{new_combo_name}* will be "
