"""Full code combining all components
 ...
 - Ordered functions
 - Reduced hard-coding in maximum items added in create
 - Made print_combo a little prettier
 - Added divisions in between prints to make things clearer
